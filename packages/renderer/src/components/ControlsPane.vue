<template>
    <div class="controls-pane">
        <div class="left-pane">
            ...
            <button :disabled="!isDownloadEnabled" @click="download">Download</button>
        </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const isDownloadEnabled = computed((): boolean => {
            return !!selectedTiles.value && selectedTiles.value < 250
        })
        ...
        return {zoomLevel, scale, selectionStart, selectionEnd, selectedTiles, download, isDownloadEnabled, contact, donate, mapType}
    },
